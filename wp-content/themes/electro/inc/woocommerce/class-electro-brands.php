	...
	public function add_brand_fields() {
		...
		<div class="form-field">
			...
			<div style="line-height:60px;">
				...
				<button type="button" class="ec_br_upload_image_button button"><?php esc_html_e( 'Upload/Add image', 'electro' ); ?></button>
				<button type="button" class="ec_br_remove_image_button button"><?php esc_html_e( 'Remove image', 'electro' ); ?></button>
			</div>
		...
		<tr class="form-field">
			...
			<td>
				...
				<div style="line-height:60px;">
					...
					<button type="submit" class="ec_br_remove_image_button button"><?php esc_html_e( 'Remove image', 'electro' ); ?></button>
				</div>
				<script type="text/javascript">
