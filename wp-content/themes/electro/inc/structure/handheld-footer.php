...
if ( ! function_exists( 'electro_footer_v2_handheld_wrap_open' ) ) {
    ...
    function electro_footer_v2_handheld_wrap_open() {
        $handheld_class = electro_get_handheld_footer_version() == 'v2' ? 'handheld-v2' : 'handheld-v1';
        ?><div class="handheld <?php echo esc_attr( $handheld_class ); ?>">
        <?php
    }
}
  ...
  function electro_footer_logo_v2() {
    ...
    if ( apply_filters( 'electro_footer_logo', true ) ) {
      ...
      <div class="footer-logo">
        <svg version="1.1" x="0px" y="0px" width="105px"
          height="24px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52">
