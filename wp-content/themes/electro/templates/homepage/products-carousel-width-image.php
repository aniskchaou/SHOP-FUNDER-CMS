<?php
/**
 * Products Carousel with category and image block
 *
...
$section_class = empty( $section_class ) ? 'products-carousel-category-with-image' : 'products-carousel-category-with-image ' . $section_class;
if ( ! empty( $animation ) ) {
    $section_class .= ' animate-in-view';
}

$class = 'products-carousel-category-with-image-inner ';
