<?php
if ( ! function_exists( 'electro_vc_products_carousel_category_with_image_block' ) ) :

function electro_vc_products_carousel_category_with_image_block( $atts, $content = null ) {
...
add_shortcode( 'electro_vc_products_carousel_category_with_image' , 'electro_vc_products_carousel_category_with_image_block' );
